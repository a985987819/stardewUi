...
export type CalendarGridCellButtonProps = Omit<
...
function CalendarGrid({
  ...
  return (
    <div className={styles['calendar-grid']}>
      <div className={styles['calendar-grid__header']}>
        <h2 className={styles['calendar-grid__month-label']}>{monthLabel}</h2>
      </div>
        ...
        <div className={styles['calendar-grid__rowgroup']} role="rowgroup">
          <div className={styles['calendar-grid__row']} role="row">
            {WEEKDAY_LABELS.map((label) => (
              <div
                key={label}
                className={styles['calendar-grid__weekday']}
                role="columnheader"
              >
                {label}
              </div>
                ...
                return (
                  <div
                    ...
                    className={classNames(
                      ...
                      !cell.inCurrentMonth && styles['calendar-grid__cell--outside-month'],
                      cell.isToday && styles['calendar-grid__cell--today'],
                      disabled && styles['calendar-grid__cell--disabled'],
                      hiddenOutsideDay && styles['calendar-grid__cell--hidden-outside'],
                  ...
                  >
                    {hiddenOutsideDay ? (
                      <div
                        className={classNames(
                          styles['calendar-grid__button'],
                          styles['calendar-grid__button--placeholder'],
                        )}
                        aria-hidden="true"
                      >
                      ...
                      <button
                        ...
                        onClick={() => {
                          if (!disabled) {
                            onSelectDay?.(cell.dateTimestamp)
                          }
                        }}
                      >
                        <span className={styles['calendar-grid__day-number']}>
                        ...
                        {renderCellContent ? (
                          <span className={styles['calendar-grid__content']}>
