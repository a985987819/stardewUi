...
function StarEmptyStateDemoPage() {
  return (
    <ComponentPage
      ...
      description="用于列表、搜索结果和占位区域的空状态组件，支持默认图片、文案开关以及横向和竖向布局。"
      toc={tocItems}
    >
      <ComponentDemo id="basic" title="基础用法" description="默认使用 public/noData.png 和提示文案。" code={basicCode}>
      ...
      <ComponentDemo
        id="horizontal"
        title="横向布局"
        description="适合表格筛选、搜索结果等更扁平的内容区域。"
        code={horizontalCode}
      >
      ...
      <ComponentDemo
        id="visibility"
        title="显示控制"
        description="可以单独隐藏图片或提示语，适配不同业务区块。"
        code={visibilityCode}
      >
      ...
      <ComponentDemo id="custom" title="自定义内容" description="可以替换图片、替代文本和文案内容。" code={customCode}>
      ...
      <div id="api" className="component-page-api">
        <ApiTable data={emptyStateApiData} />
      </div>
    </ComponentPage>
  )
}
